sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("zexc13/ui/demo/app", ".html");
			sHash = sHash || "";
			sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

			if (sHash) {
				sHash = "#DemoMasterListApp-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
			} else {
				sHash = "#DemoMasterListApp-display";
			}

			return sUrl + sUrlParameters + sHash;
		}

		return Opa5.extend("zexc13.ui.demo.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["zexc13/ui/demo/localService/mockserver"], function (mockserver) {
